...
{
    public class SelectEmployeeAbsenceAdjustmentRequest : IMandantRequest, IMitarbeiterRequest, ITransactionId
    {
        public SelectEmployeeAbsenceAdjustmentRequest()
        {
        ...
        public DateTimeOffset? RequestPeriodBegin { set; get; }

        [Description("Ende des abgefragten Zeitraums")]
        public DateTimeOffset? RequestPeriodEnd { set; get; }
    }
}
